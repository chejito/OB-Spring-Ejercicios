...
public class Ejercicio2Application {
	...
	public static void main(String[] args) {
		...
		// Crear laptop
		Laptop laptop1 = new Laptop(null, "Lenovo", "IdeaPad3", "Windows 10 Home", "Intel Core i3-1115G4", "Intel UHD Graphics", 2020, 8, 256);
		Laptop laptop2 = new Laptop(null, "Acer", "Nitro 5 ", "No OS", "Intel Core i5-10300H", "Nvidia RTX2060", 2021, 16, 512);
